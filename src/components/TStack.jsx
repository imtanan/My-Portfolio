    ...
    <div className="pt-7">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-35 justify-center py-8">
          ...
          <div className="w-16 h-16 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:scale-105 hover:text-[#6944ee] hover:bg-white/10 transition duration-300">
            <svg viewBox="0 0 32 32" fill="currentColor" className="text-[#d1d5db] hover:text-[#6944ee]">
              <path d="M15.994141 3C..." />
            </svg>
          </div>

          {/* Express */}
          <div className="w-16 h-16 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:scale-105 hover:text-[#6944ee] hover:bg-white/10 transition duration-300">
            <svg viewBox="0 0 24 24" fill="currentColor" className="text-[#d1d5db] hover:text-[#6944ee]">
              <path d="M24 18.588a1.529..." />
            </svg>
          </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-35 justify-center py-8">
          <div className="w-16 h-16 flex items-center justify-center rounded-xl bg-white/5 border border-white/10 hover:scale-105 hover:text-[#6944ee] hover:bg-white/10 transition duration-300">
            <svg viewBox="0 0 16 16" fill="currentColor" className="text-[#d1d5db] hover:text-[#6944ee]">
              <path d="M15,5.6,10.4,1A3.4..." />
            </svg>
          </div>
        </div>
      </div>
